        ...
        return {
          ...
          laneSetting:{
            ...
            ,jsplumbSetting: {
                ...
                Connector: ['Flowchart', { curviness: 20, stub: 20, gap: 1, alwaysRespectStubs: false, midpoint: 0.5, cornerRadius: 10}],
                 ...
                 * 图像端点
                 */
                // Endpoint: ['Image', {src: 'https://www.icon.net/api/resizeApi.php?id=1181776&size=32', cssClass: 'ef-img', hoverClass: 'ef-img-hover'}],
                /**
                 * 空白端点
                 */
                Endpoint: ['Dot', {radius: 5, Overlays: ''}],
              ...
              /**
                ...
                RenderMode: 'svg',
                // 鼠标滑过线的样式
                HoverPaintStyle: {stroke: '#ab2929', strokeWidth: 2},
                // 滑过锚点效果
